                ...
                <div class="col-lg-10">
                    ...
                    <div class="nav nav-tabs"></div>
                        <ul>
                            ...
                            <li><a href="../../../OnlineFoodOrdering/addcustomerform">New User</a>
                             </li>
...
<!-- The form -->
<form class="example" action="fooddisplay.jsp">
  <input type="text" placeholder="Search your favourite food" name="item_name">
